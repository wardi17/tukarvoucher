...
<div id="main">
  ...
  <script>
    ...
    function generateDetailTable(data) {
        ...
        return `
            <div>
                <button type="button" onclick="printTable()" style="margin-bottom:10px;" class="btn btn-primary">
                    Cetak Tabel
                </button>
        ...
        // Tambahkan fungsi ini di luar generateDetailTable
        function printTable() {
            let tableContent = document.getElementById("tabel1").outerHTML;
