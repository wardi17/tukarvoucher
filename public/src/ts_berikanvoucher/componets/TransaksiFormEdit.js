  ...
  let cust = customerid + ' | ' + custname;
    ...
    this.form.innerHTML = `
      <div class="row col-md-12">
        ...
        <div class="col-md-11">
          <h5 class="text-center">Form Edit Berikan Voucher</h5>
        </div>
      </div>
      <div class="row mb-3">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-3">
          <input type="text"  id="noso" value="${sotransacid}" class="form-control" />
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-2">
          <input type="number"  value="${jumlah}" id="jumlah" class="form-control text-end" />
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-5">
          <textarea id="keterangan"  class="form-control" style="width:150%; height:80px;">${keterarngan}</textarea>
      ...
      rows += `
        <tr>
          <td class="text-center">${index + 1}</td>
            <td>
            <input type="text" class="form-control kodevoucher-input" value="${item.Kode_voucher}" readonly />
          </td>
          <td>
...
tomboladdketable() {
    ...
    $(document).on("click", "#addvoucher", async (event) => {
        ...
        const cekvouchertable= await this.cekkodevouchertable(kodevoucher);
        return;
...
//and fungsi add button
//validasi cek table 
async cekkodevouchertable(kodevoucher){
  let $tbody = $(this.form).find('#voucherTable tbody');
  $tbody.find('tr').each(function() {
     let kode = $(this).data('kode');
...
validateInput(inputSelector, errorSelector, errorMessage) {
  ...
  //and validasi voucher

  //fungsi untuk proses Update
  addbuttonUpdateListener() {
    //const root = document.getElementById('root');
    $(document).off('click', '#Update').on('click', '#Update', async (e) => {
        e.preventDefault();
          Swal.fire({
          icon: "info",
          title: "Info",
          text: "Tombol Update Masih dalam Pengembangan lanjutan."
        });
